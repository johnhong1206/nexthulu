    ...
    <div>
      ...
      <main>
        ...
        >
          ...
          />
          <div className="bg-transparent bg-gradient-to-t from-[#00000] rounded-2xl opacity-100">
            <h1 className="text-xl md:text-3xl lg:text-5xl text-gray-800 font-medium">
